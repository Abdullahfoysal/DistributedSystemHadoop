...
public class WordCountDriver extends Configured implements Tool {
 ...
 class WordCountMapper extends Mapper<LongWritable, Text, Text, IntWritable> {
  ...
  class WordCountMapper1 extends Mapper<LongWritable, Text, Text, IntWritable> {
		private final static IntWritable Count = new IntWritable(1);
	    Text word = new Text();
   ...
   class WordCountMapper2 extends Mapper< Text, Text, IntWritable, Text> {
    ...
    class WordCountReducer extends Reducer<Text, IntWritable, Text, IntWritable> {
     ...
     class WordCountReducer2 extends Reducer<IntWritable, Text, IntWritable, Text> {
